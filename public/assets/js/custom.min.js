...
function appendChildren(e, t) {
    for (const s of t) e.appendChild(s);
}
function arrayCompare(e, t) {
    let s = [],
        n = [],
        i = [];
    for (el of e) t.includes(el) ? i.push(el) : s.push(el);
    for (el of t) e.includes(el) || n.push(el);
    return { only_1: s, only_2: n, both: i };
}
function blurElements(e) {
    const t = (e) => e.classList.add("blurred");
    if (Array.isArray(e)) for (let s of e) t(s);
    else t(e);
}
function capitalize(e) {
    let t = [];
    for (const s of e.split(" ")) t.push(s.charAt().toUpperCase() + s.slice(1));
    return t.join(" ");
}
function cloneAndReplace(e) {
    let t;
    if (Array.isArray(e)) {
        t = [];
        for (const s of e)
            t.push(s.parentNode.replaceChild(s.cloneNode(!0), s));
    } else t = e.parentNode.replaceChild(e.cloneNode(!0), e);
    return t;
}
function commentUp(e) {
    e.classList.add("up");
}
function commentDown(e) {
    Array.isArray(e)
        ? e.forEach((e) => e.classList.remove("up"))
        : e.classList.remove("up");
}
function convertRemToPixels(e) {
    return e * parseFloat(getComputedStyle(document.documentElement).fontSize);
}
function disable(e) {
    const t = (e) => (e.disabled = !0);
    if (Array.isArray(e)) for (let s of e) t(s);
    else t(e);
}
function elEnableTimer(e) {
    const t = (e) => {
        !1 === e.hidden &&
            setTimeout(function () {
                enable(e);
    ...
    if (Array.isArray(e)) for (const s of e) t(s);
    else t(e);
}
function emptyEl(e) {
    if (Array.isArray(e))
        for (const t of e)
            t.classList.add("hidden", "loading"), (t.textContent = "");
    else e.classList.add("hidden", "loading"), (e.textContent = "");
}
function emptyModal(e) {
    let t = Array.from(e.getElementsByTagName("input")).concat(
            Array.from(e.getElementsByTagName("textarea"))
        ),
        s = Array.from(e.getElementsByClassName("selectize-selected"));
    resetFields(t), removeChildren(s, !0);
}
function enable(e) {
    const t = (e) => (e.disabled = !1);
    if (Array.isArray(e)) for (let s of e) t(s);
    else t(e);
}
function fadeIn(e, t) {
    const s = (e) => {
        (e.hidden = !1),
            ...
            e.getElementsByTagName("input").length > 0 &&
                enable(e.getElementsByTagName("input")[0]),
            "phone-container" === e.id &&
                e
                    .getElementsByClassName("iti__selected-flag")[0]
                    .setAttribute("tabindex", "0"),
            setTimeout(e.classList.remove("fadeout"), 50),
            t && t.dropdown && hideOnClickOutside(e, e.closest("fieldset"));
    };
    if (Array.isArray(e)) for (let t of e) s(t);
    else s(e);
}
function fadeOut(e, t) {
    const s = (e) => {
        (e.disabled = !0),
            ...
            e.getElementsByTagName("input").length > 0 &&
                disable(e.getElementsByTagName("input")[0]),
            void 0 !== t &&
                !0 === t.hide &&
                setTimeout(() => {
                    e.hidden = !0;
...
function fetchDataTimer(e, t) {
    if ((clearTimeout(timer), void 0 !== t.selectize))
        if (e.value)
            timer = setTimeout(() => {
                fetchSelectizeData(e, t.selectize);
            }, 50);
        else {
            clearTimeout(timer);
            let t = e.parentNode.getElementsByTagName("ul")[0];
            fadeOut(t), removeChildren(t, !0);
        }
}
function hideOnClickOutside(e, t = e) {
    const s = (n) => {
        t.contains(n.target) || e.classList.contains("fadeout") || fadeOut(e),
            document.removeEventListener("click", s);
    };
    document.addEventListener("click", s);
}
function highlightSearch(e, t) {
    Array.isArray(t) && (t = t.filter((e) => "" !== e).join("|"));
    const s = new RegExp(`((^|\\b|\\w+)(${t})($|\\b|\\w+))`, "gi"),
        n = (e) => {
            (e.innerHTML = e.innerHTML.replace(/(<mark>|<\/mark>)/gim, "")),
                (e.innerHTML = e.textContent.replace(s, "<mark>$&</mark>"));
        };
...
function invalidate(e) {
    e.classList.contains("valid")
        ? e.classList.replace("valid", "invalid")
        : e.classList.add("invalid");
}
function loadIn(e) {
    if (Array.isArray(e))
        for (let t = 0; t < e.length; t++)
            e[t].classList.add("loading"), e[t].classList.remove("hidden");
    else e.classList.add("loading"), e.classList.remove("hidden");
}
function loadOut(e) {
    if (Array.isArray(e))
        for (let t = 0; t < e.length; t++) e[t].classList.remove("loading");
    else e.classList.remove("loading");
}
function normalizePlus(e) {
    return e
        .trim()
        .toLocaleLowerCase()
        .normalize("NFD")
...
function refreshTabData(e, t) {
    const s = Tabulator.findTable(".tabulator");
    if (s)
        for (const n of s) {
            const s = n.element.closest("fieldset").getAttribute("data-t");
            if ((!t || t.includes(parseInt(s))) && e.contains(n.element)) {
                const e = { f: parseInt(6), t: parseInt(s) };
                socket.send(e);
            }
        }
}
function removeAttributes(e, t) {
    if (void 0 !== t) for (const s of t) e.removeAttribute(s);
    else {
        let t = [];
...
function removeChildren(e, t = !1) {
    if (
        ((action = (e) => {
            let s,
                n = e.children.length - 1,
                i = !1 === t ? 0 : -1;
            for (s = n; s > i; s--) e.children[s].remove();
        }),
        Array.isArray(e))
    )
        for (let t of e) action(t);
    else action(e);
}
function removeOptions(e, t = !1) {
    let s,
        n = e.options.length - 1,
        i = !1 === t ? 0 : -1;
    if (n >= 0) for (s = n; s > i; s--) e.options[s].remove();
}
function resetFields(e) {
    if (Array.isArray(e)) for (let t = 0; t < e.length; t++) e[t].value = "";
    else e.value = "";
}
...
function resetModal(e) {
    tabuDestroy(e),
        removeAttributes(e),
        (e.getElementsByTagName("h2")[0].textContent = "");
    for (let t = 1; e.children.length > 2; ) e.children[t].remove();
    return e;
}
...
function setElementAttributes(e, t) {
    for (let [s, n] of t) e.setAttribute(s, n);
}
function setElementDraggable(e, t) {
    if (
        ...
        (e.onpointerdown = function (s) {
            if (
                ["div", "ul", "li", "nav"].includes(
                    s.target.tagName.toLowerCase()
                )
            ) {
                const a = e.getBoundingClientRect(),
                    o = t?.parent
                        ? t.parent.getBoundingClientRect()
                ...
                function n(s, n) {
                    let i, a;
                    if (
                        (e.classList.remove("left", "right", "top", "bottom"),
                        o && t?.constrain)
                    ) {
                        const t = s - r - c,
                            h = n - l - d,
                            u = o.right - e.offsetWidth - c,
                            p = o.bottom - e.offsetHeight - d;
                        (i = t < 0 ? 0 : t > u ? u : t),
                            (a = h < 0 ? 0 : h > p ? p : h);
                    } else (i = s - r - c), (a = n - l - d);
                    t?.magnet &&
                        (s - o.left < 100 && ((i = 0), e.classList.add("left")),
                        o.right - s < 100 &&
                            ((i = o.right - e.offsetWidth),
                            e.classList.add("right")),
                        n - o.top < 100 && ((a = 0), e.classList.add("top")),
                        o.bottom - n < 100 &&
                            ((a = o.bottom - e.offsetHeight),
                            e.classList.add("bottom"))),
                        (e.style.left = i + "px"),
                        (e.style.top = a + "px");
                }
                function i(e) {
                    e.preventDefault(), n(e.pageX, e.pageY);
                }
                e.classList.add("up"),
                    e.classList.remove("left", "right", "top", "bottom"),
                    n(s.pageX, s.pageY),
                    ...
                    e.classList.remove("up"),
                        t?.magnet &&
                            ((e.classList.contains("left") ||
                                ...
                                (e.style.left = ""),
                            (e.classList.contains("top") ||
                                e.classList.contains("bottom")) &&
                                ((e.style.top = ""), (e.style.left = "")));
                };
                document.addEventListener(
                    "pointerup",
                    () => {
                        document.removeEventListener("pointermove", i), h(e);
                    },
                    { once: !0 }
                ),
...
function setElementResizable(e, t) {}
function tabuDestroy(e) {
    let t = Tabulator.findTable(".tabulator");
    const s = (e) => {
        for (const s of t) e.contains(s.element) && s.destroy();
    };
    if (t)
        if (Array.isArray(e)) for (const t of e) s(t);
        else s(e);
}
function toggleClasses(e, t) {
    for (const s of t.classes)
        if (e.classList.contains(s)) {
            const n = t.classes.indexOf(s);
            return (
                e.classList.remove(s),
                void (n + 1 !== t.classes.length || t.none
                    ? n + 1 < t.classes.length &&
                      e.classList.add(t.classes[n + 1])
                    : e.classList.add(t.classes[0]))
            );
        }
    t.none
        ? e.classList.add(t.classes[0])
...
function togglePw(e) {
    const t = e.getElementsByTagName("input")[0],
        ...
        n = e.getElementsByTagName("svg")[0].getElementsByTagName("path");
    "password" === s
        ? (t.setAttribute("type", "text"),
          n[0].classList.add("hide"),
          n[1].classList.remove("hide"))
        : "text" === s &&
          (t.setAttribute("type", "password"),
          n[0].classList.remove("hide"),
          n[1].classList.add("hide"));
}
function unblurElements(e) {
    const t = (e) => e.classList.remove("blurred");
    if (Array.isArray(e)) for (const s of e) t(s);
    else t(e);
}
function unsetElementDraggable(e) {
    (e.onmousedown = null), e.classList.remove("drag", "up");
}
function validate(e) {
    e.classList.contains("invalid")
        ? e.classList.replace("invalid", "valid")
...
class BopAlert {
    ...
    close() {
        null === this.wrapper.getAttribute("open")
            ? console.warn("No open BopAlert to close.")
            : (this.wrapper.close(),
              this.store.shift(),
              (this.status = void 0),
              this.store.length > 0 && this.show(this.store[0]));
    }
    new(e) {
        e !== this.status &&
            (this.store.push(e),
            null === this.wrapper.getAttribute("open") && this.show(e));
    }
    show(e) {
        this.reset(), (this.status = e), (this.message.textContent = e.content);
        const t = e.type ?? "theme";
        this.wrapper.classList.add(t),
            e.btn1text
                ? ((this.btn0.textContent = "annuler"),
                  (this.btn0.className = "danger"),
                  (this.btn1.hidden = !1),
                  (this.btn1.textContent = e.btn1text),
                  this.btn1.classList.add(e.btn1style ?? "success"),
                  e.btn1listener &&
                      this.btn1.addEventListener("click", e.btn1listener),
                  e.btn2text &&
                      ((this.btn2.hidden = !1),
                      (this.btn2.textContent = e.btn2text),
                      this.btn2.classList.add(e.btn2style ?? "info"),
                      e.btn2listener &&
                          this.btn2.addEventListener("click", e.btn2listener)))
                : (this.btn0.className = t ?? "theme"),
            this.btn0.addEventListener("click", function () {
                e.btn0listener && e.btn0listener(), msg.close();
            }),
...
class BopChat {
    ...
    constructor(e, t) {
        if (
            ...
            "chat" === e.id &&
                ...
                (this.searchTab.hidden = !0),
                (this.searchTab.textContent =
                    "Vous pouvez utiliser la zone d'écriture ci dessous pour chercher un utilisateur avec qui ouvrir un chat."),
                ...
                this.searchButton.addEventListener("click", () => {
                    this.searchButton.blur(), this.showTab(this.searchTab);
                }),
                ...
                switch (e.code) {
                    case "Enter":
                        e.preventDefault(),
                            e.shiftKey
                                ? (this.input.value += "\n")
                                : this.input.value && this.validate();
                        break;
                    case "ArrowUp":
            ...
            for (const e of t) socket.send({ f: 14, i: e });
        else this.showTab(this.searchTab);
    }
    addChat(e) {
        let t, s, n;
        this.chats.includes(e.id)
            ? ((s = this.content.querySelector(`[data-i="${e.id}"]`)),
              (n = s.getElementsByTagName("datalist")[0]),
              (t = this.chatTabs.querySelector(`[data-i="${e.id}"]`)),
              (s.innerHTML = ""),
              removeOptions(n, !0))
            : (this.chats.push(e.id),
              (t = document.createElement("button")),
              (s = document.createElement("div")),
              s.setAttribute("data-i", e.id),
              (n = document.createElement("datalist")),
              (t.textContent = e.name),
              t.setAttribute("data-i", e.id),
              this.chatTabs.appendChild(t),
              ...
              t.addEventListener("click", () => {
                  t.blur(),
                      this.active !== e.id
                          ? this.showTab(s)
                          : msg.new({
                                content: `Souhaitez-vous fermer l'onglet ${e.name} ?`,
                                btn1text: "Fermer",
                                btn1listener: () => {
                                    socket.send({ f: 19, i: e.id }),
                                        msg.close();
                                },
                            });
              }));
        ...
        s.appendChild(n);
        for (const t of e.content) this.addMessage(t);
        this.showTab(s);
    }
    addMessage(e) {
        let t = this.content.querySelector(`[data-i="${e.idchat}"]`);
        if (t) {
            let s,
                n = document.createElement("fieldset"),
                i = document.createElement("div"),
                a = t.querySelector(`[data-id="${e.iduser}"]`),
                o = document.createElement("legend"),
                r = document.createElement("span"),
                l = document.createElement("span");
            const c = Array.from(t.querySelectorAll("button")),
                d = new Date(1e3 * e.created),
                h = new Date(),
                u = h.getTime() - d.getTime(),
                p = 7 * 864e5;
            setElementAttributes(n, [
                ["data-t", e.created],
                ["data-i", e.iduser],
                ["data-readby", e.readby],
            ]),
                (n.className = a.getAttribute("data-position")),
                (o.textContent = a.value),
                (r.textContent = e.content);
            const m = a.getAttribute("data-avatar");
            "/" === m.substring(0, 1)
                ? (i.style.backgroundImage = m)
                : (i.textContent = m),
                appendChildren(n, [o, l, i, r]),
                (l.textContent = d.toLocaleTimeString(
                    window.navigator.language,
                    { hour: "2-digit", minute: "2-digit" }
                )),
                d.toLocaleDateString() !== h.toLocaleDateString() ||
                c.find((e) => "Aujourd'hui" === e.textContent)
                    ? d.toLocaleDateString() !== h.toLocaleDateString() &&
                      u < p &&
                      !c.find(
                          (e) =>
                              e.textContent ===
                              capitalize(
                                  d.toLocaleString(window.navigator.language, {
                                      weekday: "long",
                                      day: "numeric",
                                  })
                              )
                        ...
                        ? ((s = document.createElement("button")),
                          ...
                          s.addEventListener("click", () => {
                              s.blur();
                              for (
                                  let e = Array.from(t.children).indexOf(s) - 1;
                                  e >= 0 &&
                                  "fieldset" ===
                                      t.children[e].tagName.toLowerCase();
                                  e--
                              )
                                  t.children[e].classList.toggle("fadeout");
                          }))
                        : u > p &&
                          !c.find(
                              (e) =>
                    ...
                    : ((s = document.createElement("button")),
                      (s.className = "theme"),
                      (s.textContent = "Aujourd'hui"),
                      t.insertBefore(s, t.firstChild),
                      s.addEventListener("click", () => {
                          s.blur();
                          const e = Array.from(t.children).indexOf(s);
                          for (let s = 0; s < e; s++)
                              t.children[s].classList.toggle("fadeout");
                      })),
    ...
    static destroyAll() {
        for (const e of BopChat.chats) e.destroy();
    }
    expand() {
    ...
    parseData(e) {
        const t = this.input,
            s = this.ul;
        if (e.response[0])
            if (e.response[0].fail)
                msg.new({
                    content: e.response[0].fail,
                    btn0listener: () => t.focus(),
                }),
                    (t.value = t.value.trim());
            else if (e.response[0].content) {
                let n = [];
                removeChildren(s, !0);
                for (const t of e.response) {
                    const e = `${t.id}`;
                    if (null !== t.id && !n.includes(e)) {
                        let n = document.createElement("li"),
                            i = document.createElement("span");
                        if (
                            (n.setAttribute("data-select", e),
                            ...
                            (e.textContent = `(${t.secondary})`), n.append(e);
                        }
                        if (t.role) {
                            const e = t.role.split(",");
                            for (const t of e) {
                ...
                highlightSearch(
                    Array.from(s.getElementsByTagName("span")),
                    t.value.split(" ")
                );
                ...
                s.children.length > 0
                    ? fadeIn(s, { dropdown: s.closest("fieldset") })
                    : fadeOut(s);
            } else fadeOut(s);
        else fadeOut(s);
    }
    refresh(e) {
        socket.send({ f: 14, i: e });
    }
    remove(e) {
        const t = this.content.querySelector(`[data-i='${e}']`),
            s = this.chatTabs.querySelector(`[data-i='${e}']`);
        this.active === e && this.showTab(t.previousElementSibling),
            t.remove(),
            s.remove(),
            this.chats.splice(this.chats.indexOf(e), 1);
    }
    request(e) {
        socket.send({ f: 17, i: e, c: this.active > 0 ? this.active : void 0 });
    }
    selectizeKeysNav(e) {
        switch (e.code) {
            case "ArrowUp":
                e.preventDefault(), e.currentTarget.nextSibling?.focus();
                break;
            case "ArrowDown":
                e.preventDefault(),
            ...
            case "Space":
                ...
                break;
            case "Escape":
                e.preventDefault(), fadeOut(this.ul), this.input[0].blur();
        }
    }
    send(e) {
        socket.send({ i: e.id, m: e.message, f: 16 }),
            (this.input.disabled = !0);
    }
    showTab(e) {
        const t = parseInt(e.getAttribute("data-i"));
        if (t !== this.active) {
            let s = Array.from(this.content.children);
            if (
                ...
                for (const t of Array.from(
                    e.getElementsByTagName("datalist")[0].children
                ))
                    if (parseInt(t.getAttribute("data-status")) < 2) {
                        ...
                        (s.textContent = t.value),
                            ...
                            (e.className = t.getAttribute("data-position")),
                            1 === parseInt(t.getAttribute("data-status")) &&
                                e.classList.add("offline");
                        const i = t.getAttribute("data-avatar");
                        "/" === i.substring(0, 1)
                            ? (n.style.backgroundImage = i)
                            : (n.textContent = i),
                            appendChildren(e, [n, s]),
                            this.users.appendChild(e),
    ...
    async typing() {
        0 === this.typingToggle &&
            this.input.value &&
            (socket.send({ f: 15, i: this.active }),
            (this.typingToggle = 1),
    ...
    updateUsers(e) {
        if (this.content.querySelector(`[data-i='${e.id}']`)) {
            let t = [],
                s = this.content
                    .querySelector(`[data-i='${e.id}']`)
            ...
            if (this.active === parseInt(e.id)) {
                let e = [],
                    n = this.users.children;
                for (let t of n) e.push(parseInt(t.getAttribute("data-id")));
                const i = arrayCompare(t, e);
                for (const e of i.only_1) {
                    const t = s.querySelector(`[data-id='${e}']`);
                    if (parseInt(t.getAttribute("data-status")) < 2) {
                        ...
                        (n.textContent = t.value),
                            ...
                            (s.className =
                                t.getAttribute("data-position") + " fadeout"),
                            1 === parseInt(t.getAttribute("data-status")) &&
                                s.classList.add("offline");
                        const a = t.getAttribute("data-avatar");
                        "/" === a.substring(0, 1)
                            ? (i.style.backgroundImage = a)
                            : (i.textContent = a),
                            appendChildren(s, [i, n]),
                            this.users.appendChild(s),
                            fadeIn(s);
                    }
                }
                for (const e of i.only_2)
                    (el = this.users.querySelector(`[data-id='${e}']`)),
                        el.remove();
                for (const e of i.both) {
                    switch (
                        parseInt(
                            s
    ...
    validate() {
        this.sendButton.blur(),
            (this.input.disabled = !0),
            this.send({ id: this.active, message: this.input.value });
    }
    writeEmail() {}
}
class BopTable {
    static tables = [];
    constructor(e) {
        if (void 0 === e.task && void 0 === e.rows)
            return console.error("BopTable: no data set.");
        0 === BopTable.tables.length &&
        ...
        (this.menu.icons.innerHTML =
            ...
            s.addEventListener("click", () => {
                this.menu.search.classList.toggle("active"),
                    this.menu.search.classList.contains("active")
                        ? ((n.disabled = !1), n.focus())
                        : (n.disabled = !0);
            }),
                ...
                console.log(this.menu.col),
                    this.menu.wrapper.classList.contains("head")
                        ? this.tbody
                              ...
                              .forEach((e) =>
                                  e.children[this.menu.col].classList.add(
                                      "search"
                                  )
                              )
                        : this.tbody.classList.add("search");
            }),
            n.addEventListener("blur", () => {
                this.table
                    .querySelectorAll(".search")
                    .forEach((e) => e.classList.remove("search"));
            }),
            ...
            appendChildren(this.menu.search, [s, n]),
            this.menu.search.appendChild(n),
            t.appendChild(this.menu.colsDrop),
    ...
    colGrid() {
        ...
        let t = this.cols.map((e) => e.width ?? "1fr"),
            s = 0,
            n = this.table.getBoundingClientRect().width;
        if (1 === t.filter((e) => "0fr" !== e).length)
            for (const [e, s] of t.entries()) "0fr" !== s && (t[e] = "1fr");
        else {
            for (let [i, a] of t.entries())
                if ("rem" === a.slice(-3)) {
                    const s = e * parseFloat(a);
                    (t[i] = s + "px"), (n -= s);
                } else
                    "px" === a.slice(-2)
                        ? (n -= parseFloat(a))
                        : "fr" === a.slice(-2) && (s += parseFloat(a));
            let i;
            if (s > 0) {
                const e = n / s;
                for (const [s, n] of t.entries())
                    if ("px" === n.slice(-2)) {
                        const a = parseFloat(n) / e;
                        (t[s] = a + "fr"),
                            a > 0 &&
                                (i && a < parseFloat(t[i])
                                    ? (i = s)
                        ...
                        parseFloat(n) > 0 &&
                            (i && parseFloat(n) < parseFloat(t[i])
                                ? (i = s)
                                : i || (i = s));
                const a = 1 / parseFloat(t[i]);
                for (let e of t) e = parseFloat(e) * a + "fr";
            } else {
                for (const [e, s] of t.entries())
                    "px" === s.slice(-2) &&
                        parseFloat(s) > 0 &&
                        (i && parseFloat(s) < parseFloat(t[i])
                            ? (i = e)
                            : i || (i = e));
                const e = 1 / parseFloat(t[i]);
                for (const [s, n] of t.entries())
                    "px" === n.slice(-2) && (t[s] = parseFloat(n) * e + "fr");
            }
        }
        const i = t.join(" ");
        (this.thead.style.gridTemplateColumns = i),
            (this.tbody.style.gridTemplateColumns = i),
            this.cols.map((e) => e.head.classList.remove("last")),
            this.cols
                .filter((e) => "0fr" !== e.width)
                .pop()
    ...
    static destroyAll() {
        for (const e of BopTable.tables) e.destroy();
    }
    dockMenu() {
        this.menuMove(),
        ...
        (this.menu.search.getElementsByTagName("span")[0].style = ""),
            this.menu.observer?.disconnect(),
            delete this.menu.observer,
            delete this.menu.col;
    }
    static find(e) {
        for (const t of BopTable.tables)
            if (t.wrapper.contains(e) || t.wrapper === e) return t;
        return !1;
    }
    findCol(e) {
        for (const t of this.cols)
            if (t.head === e || t.head.contains(e)) return t;
        return !1;
    }
    headClick(e) {
        const t = this.menu.wrapper;
        if (e.id === this.menu.col && t.classList.contains("head"))
            return this.dockMenu();
        this.menuToHead(e.id), t.classList.add("head");
    }
    headOver(e) {
        this.menu.wrapper.classList.contains("head") &&
            this.menu.col !== e.id &&
    ...
    loadDown(e, t) {
        let s = 1,
            n = ++e;
        const i = this.search.rows ?? this.rows;
        for (; s < t && n < i.length; ) this.loadRow(n++), s++;
        return --n;
    }
    loadUp() {}
    static menuListener(e) {
        BopTable.tables.map((t) => {
            t.menu.wrapper.contains(e.target) ||
                t.thead.contains(e.target) ||
                !t.menu.wrapper.classList.contains("head") ||
                t.dockMenu(),
                "" ===
                    t.menu.search.getElementsByTagName("span")[0].textContent &&
                    ((t.menu.wrapper.classList.contains("head") &&
                        !t.menu.search.contains(e.target)) ||
                        (!t.menu.wrapper.classList.contains("head") &&
                            !t.menu.wrapper.contains(e.target))) &&
                    t.menu.search.classList.remove("active");
        });
    }
    async menuMove() {
        this.timeout && clearTimeout(this.timeout);
        const e = this.menu.wrapper.classList;
        e.add("move");
    ...
    menuToHead(e) {
        this.menu.observer?.disconnect(),
            this.menuMove(),
            "number" == typeof e && (this.menu.col = e);
        const t = this.cols[this.menu.col],
            s = this.menu.wrapper,
            n = s.offsetParent.getBoundingClientRect(),
            i = t.head.getBoundingClientRect();
        (s.style.top =
            Math.floor(i.y + i.height - t.head.offsetTop - n.y) + "px"),
            this.menu.wrapper.classList.add("head"),
            (this.menu.icons.innerHTML =
                this.menu.colsDrop.children[t.id].children[1].innerHTML),
            this.menu.icons.children[0].addEventListener("click", () => {
                BopTable.find(s).toggleColVis(t);
            }),
            this.menu.icons.children[1].addEventListener("click", () => {
                BopTable.find(s).setGroupBy(t.id);
            }),
            this.menu.icons.children[2].addEventListener("click", () => {
                BopTable.find(s).setSortBy(t.id);
            }),
            (this.menu.observer = new ResizeObserver((e) => {
                if (s.classList.contains("head"))
                    for (const t of e) {
                        const e = t.target.getBoundingClientRect(),
                            i = convertRemToPixels(7);
                        let a,
                            o = e.width > i ? e.width : i;
                        (s.style.width = e.width > i ? e.width + "px" : ""),
                            (s.getElementsByTagName("ul")[0].style.width =
                                s.style.width);
                        const r = (e.width - i) / 2,
                            l = e.width > i ? e.x - n.x : e.x - n.x + r;
                        (a =
                            l < 0
                                ? e.x - n.x
                                : l > n.width - o
                                ? n.width - o
                                : l),
                            (s.style.left = Math.floor(a - 1) + "px");
                    }
            })),
            ...
            document.activeElement ===
                ...
                this.tbody
                    .querySelectorAll('[role="row"]')
                    .forEach((e) =>
                        e.children[this.menu.col].classList.add("search")
                    ));
    }
    multiplyRows(e) {
        for (let t = 0; t < e; t++)
    ...
    static parseData(e) {
        const t = BopTable.tables[e.i];
        (t.rows = e.response.rows),
            (t.cols = e.response.cols),
            (t.options = e.response.options),
            t.populate();
    }
    loadRow(key, top) {
        ...
        if (Array.isArray(rowData)) {
            ...
            for (const col of this.cols) {
                ...
                if (
                    ...
                    Array.isArray(rowData[col.id]))
                ) {
                    let e = [];
                    for (const t of rowData[col.id])
                        e.push(
                            "number" == typeof t &&
                                "string" == typeof col.options
                                ? this.options[col.options][t].name
                                : t
                        );
                    cell.textContent = e.join(",");
                } else
                    cell.textContent =
                        "number" == typeof rowData[col.id] &&
                        "string" == typeof col.options
                            ? this.options[col.options][rowData[col.id]].name
                            : rowData[col.id] ?? "";
                if (
                    ("number" == typeof col.groupby && (cell.width = "0fr"),
                    void 0 !== col.action)
                )
            ...
            if (
                ...
                const e = document.getElementById(`${this.id}.${key + 1}`);
                e.parentNode.insertBefore(row, e);
            } else this.scroll.last.appendChild(row);
        } else {
            this.scroll.groups.includes(rowData.col) ||
                this.scroll.groups.push(rowData.col);
            const e = this.scroll.groups.indexOf(rowData.col);
            row = document.createElement("div");
            let t = this.tbody,
                s = document.createElement("button");
            ...
            if (e > 0) for (let s = 0; s < e; s++) t = t.lastElementChild;
            !rowData.name ||
            "string" != typeof this.cols[rowData.col].options ||
            (void 0 !== this.cols[rowData.col].sortby &&
                0 !== this.cols[rowData.col].sortby)
                ? (s.textContent = rowData.name ?? "")
                : (s.textContent =
                ...
                row.appendChild(s),
                appendChildren(t, [row, n]),
                (this.scroll.last = n);
        }
        return row;
    }
    populate() {
        if (0 === this.thead.children.length) {
            ...
            for (const e of this.cols) {
                void 0 === e.width &&
                    "number" == typeof e.groupby &&
                    (e.width = "0fr"),
                    (e.oriWidth =
                        void 0 === e.width || "0fr" == e.width
                            ? "1fr"
                            : e.width);
                let t = document.createElement("li"),
                    s = document.createElement("button"),
                ...
                (t.textContent = e.name),
                    "0fr" === e.width
                        ? t.classList.add("shrunk")
                        : t.classList.remove("shrunk"),
                    (n.innerHTML = this.menu.icons.innerHTML),
                    n.addEventListener("click", (e) => {
                        e.stopPropagation();
                    }),
                    (e.visIcon = n.children[0]),
                    (e.groupIcon = n.children[1]),
                    (e.sortIcon = n.children[2]),
                    (s.textContent = "↕"),
                    s.addEventListener("click", (e) => {
                        e.stopPropagation();
                    }),
                    appendChildren(t, [s, n]),
                    t.appendChild(n),
                    t.addEventListener("click", () => {
                        this.toggleColVis(e);
                    }),
                    e.visIcon.addEventListener("click", () => {
                        BopTable.find(n).toggleColVis(e);
                    }),
                    e.groupIcon.addEventListener("click", () => {
                        BopTable.find(n).setGroupBy(e.id);
                    }),
                    e.sortIcon.addEventListener("click", () => {
                        BopTable.find(n).setSortBy(e.id);
                    }),
                    this.menu.colsDrop.appendChild(t);
                ...
                if (
                    ...
                    this.cols.indexOf(e) < this.cols.length - 1)
                ) {
                ...
                if (
                    ...
                    "number" == typeof e.sortby &&
                    1 === e.sortby
                )
                    for (const t of this.rows)
                        Array.isArray(t[e.id])
                            ? (t[e.id] = t[e.id].map(
                                  (t) => this.options[e.options][t].name
                              ))
                            : (t[e.id] =
                                  this.options[e.options][t[e.id]]?.name ?? "");
            }
            this.colGrid(), this.sort();
        } else {
            const e = {
                root: this.tbody,
            ...
            const t = (e, t) => {
                const s = this.search.rows ?? this.rows;
                s.length > 0 &&
                    e.forEach((e) => {
                        if (e.target === this.scroll.topRow.firstElementChild) {
                            if (e.isIntersecting) {
                                const e =
                                    parseInt(
            ...
            this.scroll.rowObserver = new IntersectionObserver(t, e);
            ...
            (this.tbody.innerHTML = ""),
                ...
                (this.scroll.groups = []);
            for (const [e, t] of this.search.rows?.entries() ??
                this.rows.entries()) {
                const t = this.loadRow(e);
                if (t) {
                    if (this.scroll.topRow) {
                        (this.scroll.bottomRow = t),
                            this.scroll.rowObserver.observe(
                                t.firstElementChild
                            );
                        break;
                    }
                    (this.scroll.topRow = t),
                        this.scroll.rowObserver.observe(t.firstElementChild);
                }
            }
            console.log(performance.now() - s + "ms draw");
        }
    }
    reset() {
        delete this.sorted,
    ...
    resizeCol(e) {
        const t = this;
        let s;
        for (let t = e.id + 1; t < this.cols.length; t++)
            if (this.cols[t].head.offsetWidth > 0) {
                s = t;
                break;
            }
        const n = e.head.offsetWidth + this.cols[s].head.offsetWidth;
        this.table.classList.add("resize"), this.dockMenu();
        const i = (i) => {
            const a = i.pageX - e.head.getBoundingClientRect().left,
                o = n - a;
            a > 32 &&
                o > 32 &&
                ((t.cols[e.id].width = `${a}px`),
                (t.cols[s].width = `${o}px`),
                t.colGrid());
        };
        document.addEventListener("pointermove", i),
    ...
    search(e, t) {
        ...
        if (
            ...
            (this.rows = this.rows.filter(
                (e) => Array.isArray(e) && !this.tempRows?.includes(e)
            )),
                delete this.tempRows,
                (this.search.string = e),
                (this.search.col = t ?? this.menu.col ?? void 0);
            const n = e.split(" ").map((e) => normalizePlus(e)),
                i = (e) => {
                    for (let t = s.length - 1; t >= 0; t--)
                        normalizePlus(e).includes(s[t]) && s.splice(t, 1);
                },
                a = (e, t) => {
                    if (e)
                        switch (typeof e) {
                            case "number":
                                "string" == typeof this.cols[t].options
                                    ? i(
                                          this.options[this.cols[t].options][
                                              `${e}`
                                          ].name
                                      )
                                    : i(`${e}`);
            ...
            this.search.rows = this.rows.filter((e) => {
                const t = this.search.col
                    ? [this.search.col]
                    : this.cols.map((e) => e.id);
                return o(e, t), !(s.length > 0);
            });
        }
        console.log(performance.now() - s + "ms search"), this.sort();
    }
    setGroupBy(e) {
        const t = this.setGroups().map((e) => e[1]);
        if (t.includes(e)) {
            const s = t.indexOf(e);
            s > 0
                ? ((this.cols[e].groupby = s - 1),
                  (this.cols[t[s - 1]].groupby = s))
                : (t.map((e, t) => (this.cols[e].groupby = t - 1)),
                  delete this.cols[e].groupby);
        } else
            this.cols[e].groupby =
                t.length > 0 ? this.cols[t[t.length - 1]].groupby + 1 : 0;
        void 0 === this.cols[e].sorting && (this.cols[e].sorting = 0),
            this.sort();
    }
    setGroups() {
        let e = [];
        for (const t of this.cols)
            "number" == typeof t.groupby &&
                e.push({ col: t.id, dir: t.sorting ?? 0, id: t.groupby });
        return quicksort(e, [[0, "id"]]).map((e) => [e.dir, e.col]);
    }
    setSortBy(e) {
        for (const t of this.cols)
            t.id === e
                ? "number" == typeof t.groupby
                    ? (t.sorting =
                          "number" == typeof t.sorting && 0 === t.sorting
                              ? 1
                              : 0)
                    : void 0 === t.sorting
                    ? (t.sorting = 0)
                    : 0 === t.sorting
                    ? (t.sorting = 1)
                    : (delete t.sorting, (this.cols[0].sorting = 0))
                : void 0 === t.groupby &&
    ...
    sort() {
        let e = [0, 0],
            t = [];
        for (const s of this.cols)
            (s.sortIcon.className = ""),
                "number" == typeof s.groupby
                    ? (t.push({
                          col: s.id,
                          dir: s.sorting ?? 0,
                          id: s.groupby,
                      }),
                      (s.groupIcon.className = "on"),
                      (s.groupIcon.lastElementChild.textContent = s.groupby),
                      (s.sortIcon.className =
                          "number" == typeof s.sorting && 1 === s.sorting
                              ? "up"
                              : "down"))
                    : ((s.groupIcon.className = ""),
                      (s.groupIcon.lastElementChild.textContent = ""),
                      "number" == typeof s.sorting && (e = [s.sorting, s.id])),
                (s.visIcon.className =
                    "string" == typeof s.width && "0fr" === s.width
                        ? "hide"
                        : "show");
        (this.cols[e[1]].sortIcon.className = 1 === e[0] ? "up" : "down"),
            "number" == typeof this.menu.col &&
        ...
        ((e) => {
            if (
                ...
                if (void 0 === this.sorted || s !== this.sorted) {
                    const n = t.filter((e) => this.cols[e[1]].multi);
                    if (n.length > 0) {
                        this.tempRows = [];
                        for (const t of n)
                            e.map((e) => {
                                if (e[t[1]].length > 1) {
                                    let s = [],
                                        n = [...e[t[1]]];
                                    for (let i = 1; i < e[t[1]].length; i++)
                                        n.splice(0, 0, n.pop()),
                                            s.push([...e]),
                                            (s[i - 1][t[1]] = [...n]);
                                    this.tempRows.push(...s);
                                }
                            });
                        e = [...e, ...this.tempRows];
                    }
                    (this.sorted = s), quicksort(e, s);
                }
                if (t.length > 0) {
                    const s = e[0];
                    let n,
                    ...
                    for (const [o, r] of t.entries())
                        e.splice(i, 0, {
                            col: r[1],
                            name: Array.isArray(s[r[1]]) ? s[r[1]][0] : s[r[1]],
                            start: i + 1,
                            value: s[r[1]],
                        }),
                            (a[r[1]] = {
                                last: i++,
                                value: Array.isArray(s[r[1]])
                                    ? s[r[1]][0]
                                    : s[r[1]],
                            }),
                            (n = o);
                    for (const [s, o] of e.entries())
                        if (Array.isArray(o)) {
                            ...
                            for (const [r, l] of t.entries()) {
                                const t = Array.isArray(o[l[1]])
                                    ? o[l[1]][0]
                                    : o[l[1]];
                                (n < r || t !== a[l[1]].value) &&
                                    ((e[a[l[1]].last].end = s - 1),
                                    e.splice(i, 0, {
                                        col: l[1],
                                        name: Array.isArray(o[l[1]])
                                            ? o[l[1]][0]
                                            : o[l[1]],
                                        start: i + 1,
                                        value: o[l[1]],
                                    }),
                                    (a[l[1]] = { last: i++, value: t }),
                                    (n = r));
                            }
                        }
                }
            }
            this.search.rows ? (this.search.rows = e) : (this.rows = e),
                this.populate();
        })(this.search.rows ?? this.rows);
    }
    toggleColVis(e) {
        (e.width =
            "string" == typeof e.width && "0fr" === e.width
                ? e.oriWidth
                : "0fr"),
            "0fr" === e.width
                ? this.menu.colsDrop.children[e.id].classList.add("shrunk")
                : this.menu.colsDrop.children[e.id].classList.remove("shrunk"),
            this.cols.map((e) => {
                (e.visIcon.className =
                    "string" == typeof e.width && "0fr" === e.width
                        ? "hide"
...
function buttonDown(e) {
    e.classList.add("btn-down");
}
function buttonUp(e) {
    e.classList.remove("btn-down");
}
...
async function fetchPost(e) {
    ...
    return t.ok ? "ok" : (alert("HTTP-Error: " + t.status), "error");
}
async function fetchPostText(e) {
    let t = await fetch("/", {
        method: "POST",
        headers: {
            "Content-Type":
    ...
    return alert("HTTP-Error: " + t.status);
}
async function fetchPostJSON(e, t = !1) {
    const s = t
        ? "application/json"
        : 'application/x-www-form-urlencoded; charset="utf-8"';
    let n;
    return (
        (n = await fetch("/", {
            method: "POST",
            headers: { "Content-Type": s, Accept: "application/json" },
            body: e,
        })
            .then((e) => e.json())
            .then((e) => {
                ...
                return (
                    e.success &&
                        sweetAlert({ content: e.success, type: "success" }),
                    e
                );
            })
            .catch((e) => {
                console.error(e.error),
                    e.data && console.debug(e.data),
                    sweetAlert({ content: e.fail, type: "danger" });
            })),
        n
    );
}
...
class Field {
    ...
    constructor(e) {
        (this.wrapper = document.createElement("div")),
            ...
            (this.isValid = !1),
            this.timer,
            (this.add = e.add ?? void 0),
            (this.modal = e.modal ?? !1),
            (this.multi = e.multi),
            (this.name = e.name),
            (this.task = e.task ?? void 0),
            (this.type = e.type),
            (this.required = e.required ?? !1),
            (this.wrapper.style.gridArea = e.grid ?? null),
            "boolean" == typeof e.compact &&
                e.compact &&
                this.wrapper.classList.add("compact"),
            this.wrapper.classList.add("field");
        const t = [
            ["placeholder", e.placeholder ?? ""],
            ["aria-label", e.label ?? this.name],
        ];
        switch (this.type) {
            case "address": {
                this.wrapper, (this.fields = []);
                let t = document.createElement("h2"),
                    s = document.createElement("input"),
                    n = document.createElement("input"),
                    i = document.createElement("input"),
                    a = document.createElement("input");
                (t.textContent = "Addresse"),
                    this.wrapper.appendChild(t),
                    setElementAttributes(s, [
                    ...
                    setElementAttributes(i, [
                        ["placeholder", "Sainte Bernadette"],
                        ["aria-label", "Ville"],
                    ]),
                    setElementAttributes(a, [
                        ["placeholder", "France"],
                        ["aria-label", "Pays"],
                    ]),
                    e.value &&
                        ((s.value = e.value.street),
                        (n.value = e.value.postcode),
                        (i.value = e.value.city),
                        (a.value = e.value.country));
                for (const e of [s, n, i, a]) {
                    let t = document.createElement("div"),
                        s = document.createElement("h2");
                    (s.textContent = e.getAttribute("aria-label")),
                        appendChildren(t, [s, e]),
                        this.wrapper.appendChild(t);
                }
                this.wrapper.classList.add("address"),
                    this.input.push([s, n, i, a]);
                break;
            }
            case "email": {
                let s = document.createElement("h2"),
                    n = document.createElement("input");
                (s.textContent = e.label ?? this.name),
                    setElementAttributes(n, [
                        ["type", "email"],
                        [
                            "pattern",
                    ...
                    appendChildren(this.wrapper, [s, n]),
                    (n.value = e.value ?? ""),
                    n.addEventListener("input", function () {
                        const e = Field.find(n);
                        e.getValid(),
                            e.modal && Modal.find(n)?.checkRequiredFields();
                    }),
                    this.input.push(n);
                break;
            }
            case "input_string": {
                ...
                if (
                    ...
                    n.addEventListener("input", () => {
                        e.getValid(), Modal.find(n)?.checkRequiredFields();
                    });
                }
                this.input.push(n);
                break;
            ...
            case "input_text": {
                ...
                if (
                    ((n.textContent = e.label ?? this.name),
                    setElementAttributes(s, t),
                    appendChildren(this.wrapper, [n, s]),
                    (s.textContent = e.value ?? ""),
                    this.required)
                ) {
                    const e = this;
                    s.addEventListener("input", () => {
                        e.getValid(), Modal.find(s)?.checkRequiredFields();
                    });
                }
                this.input.push(s);
                break;
            ...
            case "new-password": {
                let t = document.createElement("h2"),
                    s = document.createElement("input");
                (t.textContent = e.label ?? this.name),
                    (s.className = "password"),
                    setElementAttributes(s, [
                        ["type", "password"],
                        [
                            "pattern",
                        ...
                        [
                            "autocomplete",
                            "password" !== this.type ? this.type : "",
                        ],
                    ]),
                    appendChildren(this.wrapper, [t, s]),
                ...
                const n = this.wrapper.getElementsByTagName("svg")[0];
                n.addEventListener("click", (e) =>
                    ...
                    "new-password" === this.type &&
                        s.addEventListener("input", function () {
                            const e = Field.find(s);
                            e.getValid(),
                                e.modal && Modal.find(s)?.checkRequiredFields();
                        }),
                    this.input.push(s);
                break;
            }
            ...
            case "select": {
                const s = { f: 7, s: this.task };
                let n = document.createElement("div"),
                    i = document.createElement("h2"),
                    a = document.createElement("input");
                (i.textContent = e.label ?? this.name),
                    (this.ul = document.createElement("ul")),
                    socket.send(s),
                    ...
                    n.append(a, this.ul),
                    appendChildren(this.wrapper, [i, n]),
                    this.input.push(a);
                break;
            }
            case "selectize": {
                ...
                if (
                    ((a.textContent = e.label ?? this.name),
                    (this.selected = {
                    ...
                    (this.ul = document.createElement("ul")),
                    (this.ul.className = "fadeout"),
                    setElementAttributes(o, [
                        ["spellcheck", "false"],
                        ["autocomplete", "off"],
                        ...t,
                    ]),
                    (n.className = "selectize-container"),
                    n.append(o, this.ul),
                    ...
                    e.add &&
                        ...
                        i.addEventListener("click", function (t) {
                            let n = [];
                            for (const e of s.selected.wrapper.children)
                                n.push(e.textContent);
                            n.includes(o.value) ||
                                (fadeOut(s.ul, { hide: !0 }), e.add(o));
                        })),
                    e.value)
                )
                    for (const [t, s] of e.value.entries()) {
                        let e = document.createElement("span");
                        s.content
                            ...
                            this.selected.items.push({
                                ...
                                group: s.group ?? void 0,
                            }),
                            this.selected.wrapper.appendChild(e);
                    }
                appendChildren(this.wrapper, [a, n, this.selected.wrapper]),
                    ...
                    o.addEventListener("keydown", (t) => {
                        switch (t.code) {
                            case "ArrowDown":
                                t.preventDefault(),
                                    s.ul.classList.contains("fadeout")
                                        ? s.wrapper.nextElementSibling?.getElementsByTagName(
                                              "input"
                                          )[0]
                                            ? s.wrapper.nextElementSibling
                            ...
                            case "ArrowUp":
                                t.preventDefault(),
                                    s.wrapper.previousElementSibling?.getElementsByTagName(
                                        "input"
                                    )[0]
                                        ? s.wrapper.previousElementSibling
                            ...
                            case "Escape":
                                ...
                                break;
                            case "Enter":
                                if (e.add && Modal.find(s.wrapper)?.hasRoom()) {
                                    let t = [];
                                    for (const e of s.selected.wrapper.children)
                    ...
                    o.addEventListener("focus", () => {
                        if (o.value.split(" ").length < 5) {
                            Field.find(o).fetchDataTimer();
                        }
                    }),
                    this.input.push(o);
                break;
            ...
            case "boptable": {
                ...
                (n.textContent = e.label ?? this.name),
                    setElementAttributes(s, t),
                    appendChildren(this.wrapper, [n, s]),
                    (e.options.caption = this.name),
                    (e.options.wrapper = s),
                    new BopTable(e.options);
                break;
            }
        }
        this.required && this.getValid(), Field.fields.push(this);
    }
    async addSelectize(e, t) {
        const s = this,
            n = Modal.find(this.wrapper);
        let i = document.createElement("span"),
            a = { id: e, element: i };
        (i.textContent = t),
            i.setAttribute("tabindex", "0"),
            this.multi ||
                (removeChildren(this.selected.wrapper, !0),
                (this.selected.items = [])),
            this.selected.items.push(a),
            this.selected.wrapper.appendChild(i),
            i.addEventListener("click", () => {
                s.selected.items.splice(s.selected.items.indexOf(a), 1),
                    i.remove(),
                    (s.isValid = s.selected.items.length > 0),
                    n?.checkRequiredFields();
            }),
    ...
    destroy() {
        Field.fields.splice(Field.fields.indexOf(this), 1),
            "table" === this.type && tabuDestroy(this.wrapper),
            this.wrapper.remove();
    }
    fetchData() {
    ...
    static find(e) {
        if (void 0 === e.parentElement) {
            let t = [];
            for (const s of Field.fields) {
                let n;
                for (const [t, i] of Object.entries(e)) n = s[t] === i;
                n && t.push(s);
            }
            return t;
        }
        for (const t of Field.fields)
            if (t.wrapper === e || t.wrapper.contains(e) || t.input.includes(e))
                return t;
    }
    getValid() {
        ...
        switch (this.type) {
                ...
                this.input[0].value
                    ? this.input[0].validity.valid
                        ...
                        : ((this.isValid = !1),
                          ...
                          (e.textContent = this.name + " (invalide)"))
                    : ((this.isValid = !1),
            ...
            case "input_string":
            case "input_text":
                this.isValid = !!this.input[0].value;
                break;
            case "phone":
                this.input[0].value
                    ? this.intlTel.isValidNumber()
                        ? ((this.isValid = !0),
                ...
                break;
            case "selectize":
                this.isValid = this.selected.length > 0;
        }
    }
    static parseData(e) {
        if (7 === e.f) {
            if (e.i) {
                const t = Field.fields[e.x],
                    s = t.input[0],
                    n = t.ul;
                if (e.response[0])
                    if (e.response[0].fail)
                        msg.new({
                            content: e.response[0].fail,
                            btn0listener: () => s.focus(),
                        }),
                            (s.value = s.value.trim());
                    else if (e.response[0].content) {
                        let i = [];
                        for (const a of t.selected.items) i.push(a.id);
                        removeChildren(n, !0);
                        for (const o of e.response)
                            if (null !== o.id && !i.includes(`${o.id}`)) {
                                let r = document.createElement("li"),
                                    l = document.createElement("span");
                                if (
                                    (r.setAttribute("data-select", o.id),
                                    r.setAttribute("tabindex", "0"),
                                    (l.textContent = o.content),
                                    r.append(l),
                                    o.secondary)
                                ) {
                                    let c = document.createElement("span");
                                    (c.textContent = `(${o.secondary})`),
                                        r.append(c);
                                }
                                if (o.role) {
                                    const d = o.role.split(",");
                                    for (const h of d) {
                                        let u =
                                ...
                                if (o.email) {
                                    r.setAttribute("data-email", o.email);
                                    let p = document.createElement("span");
                                    (p.textContent = `(${o.email})`),
                        ...
                        highlightSearch(
                            Array.from(n.getElementsByTagName("span")),
                            s.value.split(" ")
                        );
                        for (const m of n.children)
                            m.addEventListener("keydown", (e) =>
                                t.selectizeKeysNav(e)
                            ),
                        ...
                        n.children.length > 0
                            ? fadeIn(n, { dropdown: n.closest("fieldset") })
                            : fadeOut(n);
                    } else fadeOut(n);
                else fadeOut(n);
            } else if (e.response[0].content) {
                let f = Field.find({ type: "select", task: e.s });
                for (let g of f) {
                    const v = g.input[0].getAttribute("data-value") ?? "",
                        b = g.ul;
                    function w(e) {
                        g.input[0].value =
                            e.getElementsByTagName("span")[0].textContent;
                        for (let t of e.parentNode.children)
                            t.className = t === e ? "selected" : "";
                        (g.selected = e.getAttribute("data-select")),
                            fadeOut(b);
                    }
                    removeAttributes(g.input[0], [
                        "data-value",
                        "data-f",
                        "data-s",
                    ]);
                    for (const y of e.response) {
                        let C = document.createElement("li"),
                            E = document.createElement("span");
                        setElementAttributes(C, [
                            ["data-select", y.id],
                            ["tabindex", "0"],
                        ]),
                            (E.textContent = y.content),
                            v &&
                                v === y.id &&
                                ((g.input[0].value = y.content),
                    ...
                    if (!g.input[0].value) {
                        const L = b.getElementsByTagName("li")[0];
                        (L.className = "selected"),
                            (g.selected = L.getAttribute("data-select")),
                            (g.input[0].value =
                                L.getElementsByTagName("span")[0].textContent);
                    }
                    g.input[0].addEventListener("focus", () => {
                        fadeIn(b, { dropdown: b.closest("fieldset") }),
                            b.children[0].focus();
                    }),
                        g.input[0].addEventListener("click", () => {
                            fadeIn(b, { dropdown: b.closest("fieldset") }),
                                b.children[0].focus();
                        }),
                        b.addEventListener("keydown", (e) => {
                            if ("Escape" === e.code) fadeOut(b);
                        });
                }
            }
        } else
            12 === e.f &&
                e.response.id &&
                Field.fields[e.x].addSelectize(e.response.id, e.t);
    }
    selectizeKeysNav(e) {
        ...
        switch (e.code) {
            case "ArrowUp":
                ...
                break;
            case "ArrowDown":
                e.preventDefault(), t.nextSibling?.focus();
                break;
            case "Enter":
            case "Space":
                let s = [];
                Array.from(t.getElementsByTagName("span")).map((e) =>
                    s.push(e.textContent)
                ),
                    this.addSelectize(
    ...
    static updateFields() {
        for (const e of Field.fields)
            void 0 === e.wrapper &&
                Field.fields.splice(Field.fields.indexOf(e), 1);
    }
}
...
class ClassLogin {
    ...
    blankBox() {
        ...
        let e = Array.from(this.box.children);
        for (let t = e.length - 1; t > e.indexOf(this.email.wrapper); t--)
            e[t].remove();
        this.email.input[0].focus();
    }
    async checkMail() {
        if (this.email.input[0].value && this.email.input[0].validity.valid) {
            let e = await fetchPostText(
                "f=3&a=" + encodeURIComponent(this.email.input[0].value)
            );
            "1" === e && void 0 === this.currentPassword
                ? (this.blankBox(), this.loadCurrentPW())
                : "0" === e &&
                  void 0 === this.newPassword &&
                  (this.blankBox(), this.loadNewPW());
        } else this.blankBox();
    }
    checkPWCheck() {
    ...
    load() {
        loadIn(this.wrapper),
            ...
            (this.head =
                this.wrapper.getElementsByClassName("login-header")[0]);
        const e = this.wrapper.getElementsByClassName("fullscreen")[0];
    ...
    loadCurrentPW() {
        (this.currentPassword = new Field({
            ...
            this.currentPassword.input[0].addEventListener("input", (e) => {
                login.connectBtn.disabled = !e.target.value;
            }),
            this.currentPassword.input[0].addEventListener("keydown", (e) => {
                "Enter" === e.code && ClassLogin.openWS();
            }),
    ...
    loadPhone() {
        (this.phone = new Field({
            ...
            (this.commentPhone =
                this.box.getElementsByClassName("phone-msg")[0]),
            this.phone.input[0].addEventListener("input", () => {
                login.phoneCheck();
            }),
            this.phone.input[0].addEventListener("keydown", (e) => {
                "Enter" === e.code &&
                    login.phone.intlTel.isValidNumber() &&
                    login.showConfirmation();
            });
    }
    newPWCheck() {
        const e = this.newPassword.input[0].value,
            t = this.commentList.getElementsByTagName("span")[0],
            s = this.commentList.getElementsByTagName("li");
        let n = 0;
        /[a-z]+/.test(e) ? fadeOut(s[0]) : (fadeIn(s[0]), (n = 1)),
            /[A-Z]+/.test(e) ? fadeOut(s[1]) : (fadeIn(s[1]), (n = 1)),
            /[0-9]+/.test(e) ? fadeOut(s[2]) : (fadeIn(s[2]), (n = 1)),
            /[!@#$%^&*]+/.test(e) ? fadeOut(s[3]) : (fadeIn(s[3]), (n = 1)),
            e.length > 11 ? fadeOut(s[4]) : (fadeIn(s[4]), (n = 1)),
            64 === e.length ? (fadeIn(s[5]), (n = 1)) : fadeOut(s[5]),
            0 === n ? fadeOut(t) : fadeIn(t);
    }
    newPWFocus() {
        const e = this.newPassword.input[0];
        (e.validity.valid && e.value) || this.commentList.classList.add("up"),
            e.addEventListener(
                "blur",
                () => {
                    login.newPassword.input[0].value ||
    ...
    static openWS() {
        login.currentPassword.input[0].blur(), socket?.close();
        let e =
            ("localhost" === window.location.hostname ? "ws://" : "wss://") +
            window.location.host;
        socket = new WSConnection(e);
    }
    phoneCheck() {
        this.phone.input[0].value &&
            (this.phone.intlTel.isValidNumber()
                ? (this.commentPhone.classList.remove("up"),
                  (this.validBtn.disabled = !1))
                : (this.commentPhone.classList.add("up"),
                  (this.validBtn.disabled = !0)));
    }
    async register() {
        const e = encodeURIComponent(this.email.input[0].value.trim()),
            t = encodeURIComponent(this.newPassword.input[0].value),
            s =
                "f=4&email=" +
                e +
                "&phone=" +
                encodeURIComponent(this.phone.intlTel.getNumber()) +
                "&password=" +
                t;
        let n = await fetchPostText(s);
        console.log(n),
            "1" === n
                ? (console.log("res = 1"),
                  msg.new({
                      content:
                          "Votre compte a été créé ! Vous devriez recevoir sous peu un email ainsi qu'un sms nécéssaires à la validation de votre compte. En cas de difficulté, n'hésitez pas à contacter l'assistance.",
                      type: "success",
                      btn0listener: () => {
                          login.blankBox();
                      },
    ...
    showConfirmation() {
        (this.confirmationText = document.createElement("span")),
            (this.confirmationText.textContent =
                "Merci de bien vérifier les informations fournies, adresse email et numéro de téléphone portable doivent être valides et accessibles car ils seront utilisés pour finaliser la création de votre compte."),
...
class ClassMain {
    ...
    constructor(e) {
        (ClassMain.el = this),
            ...
            (this.chat = new BopChat(document.getElementById("chat"), e.chat)),
            (this.tabs = {
                active: e.active_tab ?? 1,
                data: e.tabs,
                item: [],
                map: e.tabs_map,
            }),
        ...
        const t = localStorage.getItem("navbarClass");
        (this.navbar.wrapper.className = "navbar " + (null !== t ? t : "left")),
            (null === t || t.split(" ").length < 2) &&
        ...
        (n.textContent = "theme"),
            ...
            s.addEventListener("click", (e) => {
                e.stopPropagation(), this.switchTheme();
            }),
            (this.theme = { element: s, options: ["light", "dark"] }),
            (this.theme.value = this.theme.options.indexOf(
            ...
            i.addEventListener("click", (e) => {
                e.stopPropagation(), socket.close();
            }),
            appendChildren(this.navbar.ul, [s, i]),
            ...
            e.attempts_total > 2 &&
                msg.new({
                    content: `Bienvenue ${e.name} !\n                    Pour information, ${e.attempts_total} tentatives de connexion\n                    à votre compte ont échoué depuis la dernière connexion réussie.\n                    Si ce nombre vous paraît anormal, vérifiez que votre compte soit bien sécurisé.`,
                });
    }
    appendNav(e) {}
    static destroy() {
        const e = ClassMain.el;
        e.chat.destroy(),
            (e.wrapper.innerHTML = ""),
            (e.navbar.wrapper.innerHTML = ""),
            (e.navbar.wrapper.className = "navbar left hidden loading"),
            (e.navbar.wrapper.style.top = ""),
            (e.navbar.wrapper.style.left = ""),
            (e.topbar.wrapper.innerHTML = ""),
            (e.topbar.wrapper.className = "topbar hidden loading"),
            delete ClassMain.el;
    }
    getTab() {}
    logout() {}
    navbarRelease() {
        const e = Array.from(this.navbar.wrapper.classList).filter((e) =>
            ["top", "right", "bottom", "left"].includes(e)
        );
        1 !== e.length || ("top" !== e[0] && "bottom" !== e[0])
            ? localStorage.setItem(
                  "navbarStyle",
                  this.navbar.wrapper.getAttribute("style")
              )
            : localStorage.removeItem("navbarStyle"),
            localStorage.setItem("navbarClass", e.join(" "));
    }
    parseTab(e, t) {
        (this.tabs.data[e] = t), this.loadTab(e);
    }
            ...
            if (this.tabs.data[id]) {
                ...
                if (
                    ...
                    newnav.addEventListener("click", (e) => {
                        e.stopPropagation(), this.tabSwitch(id);
                    }),
                    this.wrapper.appendChild(newtab),
                    (this.tabs.item[id] = { tab: newtab, li: newnav }),
                    this.tabs.data[id].actions?.length > 0)
                )
                    for (const value of this.tabs.data[id].actions) {
                        ...
                        if (
                            ...
                            newAction.addEventListener("click", (e) => {
                                e.stopPropagation(), eval(value.action);
                            }),
                            !this.tabs.item[id].ul)
                        ) {
                            const e = document.createElement("ul");
                            newnav.appendChild(e), (this.tabs.item[id].ul = e);
                        }
                        this.tabs.item[id].ul.appendChild(newAction);
                    }
                if (parentId) {
                    const e = this.tabs.item[parentId];
                    if (!e.ul) {
                        const t = document.createElement("ul");
                        e.li.appendChild(t), (e.ul = t);
                    }
                    e.ul.appendChild(newnav);
                } else this.navbar.ul.appendChild(newnav);
                "object" == typeof children && this.prepareTab(children, id);
            }
    }
    setThemeIcon() {
        for (let [e, t] of this.theme.options.entries()) {
            const t = this.theme.element.getElementsByTagName("svg")[e];
            e === this.theme.value
    ...
    switchTheme() {
        this.theme.value =
            this.theme.value < this.theme.options.length - 1
                ? this.theme.value + 1
                : 0;
        const e = this.theme.options[this.theme.value];
        this.setThemeIcon(),
            (document.body.className = e),
            localStorage.setItem("theme", e);
    }
    tabSwitch(e) {
        0 === this.tabs.item[e].tab.children.length
            ? this.loadTab(e)
            : (this.topbar.react.innerHTML = this.tabs.data[e]?.toolbar ?? ""),
            localStorage.setItem("active_tab", e),
            fadeOut(this.tabs.item[this.tabs.active].tab),
            this.tabs.item[this.tabs.active].li.classList.remove("active"),
            fadeIn(this.tabs.item[e].tab),
            this.tabs.item[e].li.classList.add("active"),
            (this.tabs.active = e);
    }
    loadTab(e) {
        if (this.tabs.data[e]?.fields) {
            let t = document.createElement("h1");
            (t.textContent = this.tabs.data[e].name),
                this.tabs.item[e].tab.appendChild(t);
            for (const t of this.tabs.data[e].fields)
                this.tabs.item[e].tab.appendChild(new Field(t).wrapper);
            this.topbar.react.innerHTML = this.tabs.data[e].toolbar ?? "";
        } else socket.send({ f: 20, i: e });
    }
}
themifyCache(),
    login.load(),
...
class Modal {
    ...
    constructor(e) {
        if (((this.childOf = e.childOf ?? void 0), !this.hasRoom()))
            return msg.new({
                content:
        ...
        {
            const t = document.getElementsByClassName("modal-container")[0];
            (this.task = e.task),
                (this.wrapper = document.createElement("div")),
                (this.header = document.createElement("div")),
                (this.content = document.createElement("div")),
                ...
                e.grid && this.content.classList.add("g-6"),
            ...
            for (const t of e.fields) {
                const e = new Field(t);
                this.content.appendChild(e.wrapper), this.fields.push(e);
            }
            let s = document.createElement("button"),
                n = !!e.btn1text && document.createElement("button"),
                i = !!e.btn2text && document.createElement("button");
            if (
                (s.classList.add(e.btn0style ?? "danger"),
                (s.textContent = e.btn0text ?? "annuler"),
                s.addEventListener("click", (t) => {
                    e.btn0listener
                        ? e.btn0listener(t)
                        : msg.new({
                              content:
                                  "Êtes-vous sûr de vouloir annuler ? Toutes les informations rentrées seront perdues.",
                              type: "warning",
                              btn1text: "continuer",
                              btn1style: "success",
                              btn1listener: function () {
                                  Modal.find(s).close(), msg.close();
                              },
                          });
                }),
                ...
                let t = this;
                (n.textContent = e.btn1text),
                    n.addEventListener(
                        "click",
                        e.btn1listener ?? (() => t.modalOk())
                    ),
                    n.classList.add(e.btn1style ?? "success"),
                    this.footer.appendChild(n);
            }
            i &&
                ((i.textContent = e.btn2text),
                i.addEventListener("click", e.btn2listener),
                i.classList.add(e.btn2style ?? "success"),
    ...
    checkRequiredFields() {
        for (const e of this.fields)
            if (e.required && !e.isValid) {
                for (const e of this.btns) e !== this.btns[0] && disable(e);
                return !1;
            }
        for (const e of this.btns) e !== this.btns[0] && enable(e);
        return !0;
    }
    close() {
        void 0 !== this.childOf
        ...
        for (const e of this.fields) e.destroy();
        this.wrapper.remove();
    }
    static destroy() {
        for (let e = Modal.modals.length - 1; e >= 0; e--)
            Modal.modals[e].close();
    }
    static find(e) {
        for (const t of Modal.modals) {
            for (let s = t.children.length - 1; s >= 0; s--) {
                const n = t.children[s];
                if (n.wrapper === e || n.wrapper.contains(e)) return n;
            }
            if (t.wrapper === e || t.wrapper.contains(e)) return t;
        }
        return !1;
    }
    static findParent(e) {
        for (const t of Modal.modals)
            if (t.wrapper.contains(e.wrapper)) return t;
        return e;
    }
    getData() {
        const e = Modal.findParent(this);
        let t = {
                child: e.children.indexOf(this),
                f: this.task,
                parent: Modal.modals.indexOf(e),
            },
            s = {};
        for (const e of this.fields)
            switch (e.type) {
                case "phone":
                    s[e.name] = e.phone ?? null;
                    break;
                case "selectize":
                    s[e.name] = e.selected.items.map((e) => e.id) ?? void 0;
                    break;
                case "select":
                    s[e.name] = e.selected;
                    break;
                default:
                    for (const t of e.input)
                        t.value && (s[t.getAttribute("aria-label")] = t.value);
            }
        return (t.content = s), t;
    }
    hasRoom() {
        return (
            (void 0 === this.childOf ||
                Modal.findParent(this.childOf).children.length !==
                    Modal.maxChildren) &&
            Modal.modals.length !== Modal.maxModals
        );
    }
    modalOk(e) {
        let t;
        void 0 !== e && e.confirm
            ? ((t = e.data), (t.confirm = e.confirm))
            : (t = this.getData()),
            console.warn(t),
            socket.send(t);
    }
    static parseData(e) {
        const t =
            -1 === e.child
                ...
                : Modal.modals[e.parent].children[e.child];
        switch (e.f) {
            case 8:
                msg.new({
                    content: e.response.success,
                    type: "success",
                    btn0listener: () => t.close(),
                });
                break;
            case 9:
                if (e.response.confirm) {
                    const s = e.response.confirm.content;
                    delete e.response,
                        delete e.user,
                        msg.new({
                            content: s,
                            btn1listener: () => {
                                t.modalOk({ confirm: "new", data: e }),
                                    msg.close();
                            },
                            btn1text: "créer",
                            btn2listener: () => {
            ...
            case 10:
            case 11:
                (t.childOf ?? null)?.fields[t.parentId].addSelectize(
                    e.response.id,
                    e.response.name
                ),
                    msg.new({
    ...
    setFocus() {
        const e = Modal.modals.indexOf(this);
        Modal.focus.includes(e)
            ? Modal.focus.push(Modal.focus.splice(Modal.focus.indexOf(e), 1)[0])
            : Modal.focus.push(e);
        let t = 20;
        for (const e of Modal.focus)
            Modal.modals[e]
                ? (Modal.modals[e].wrapper.style["z-index"] = t++)
                : Modal.focus.splice(Modal.focus.indexOf(e), 1);
    }
    static setMaxChildren(e) {
        Modal.maxChildren = e;
    }
    static setMaxModals(e) {
        Modal.maxModals = e;
    }
}
function loadNewCompany(e) {
    let t,
        s,
        n,
        i = "";
    ...
    const a = {
        ...
        fields: [
            ...
            { name: "Adresse", type: "address" },
            {
                add: (e) => {
                    const t = Modal.find(e),
                        s = t.fields.indexOf(Field.find(e));
                    loadNewContact({ childOf: t, name: e.value, parentId: s });
                },
                multi: !0,
                name: "Employés",
        ...
        fields: [
            ...
            },
            {
                add: (e) => {
                    const t = Modal.find(e),
                        s = t.fields.indexOf(Field.find(e));
                    loadNewCompany({ childOf: t, name: e.value, parentId: s });
                },
                multi: !1,
                name: "Société",
            ...
            { name: "Adresse", type: "address" },
            {
                add: (e) => {
                    msg.new({
                        content: `Souhaitez-vous créer le tag ${e.value} ?`,
                        btn1text: "Créer",
                        btn1style: "success",
                        btn1listener: async function () {
                            socket.send({
                                f: 12,
                                t: e.value,
                                x: Field.fields.indexOf(Field.find(e)),
                            }),
                                (e.value = ""),
                                msg.close(),
                                e.focus();
    ...
    const s = {
        ...
        btn2listener: function () {
            console.log("show date/hour picker and program mail sending"),
                msg.new({ content: "Under construction", type: "warning" });
        },
        fields: [
            {
                add: (e) => {
...
function loadNewTicket(e) {
    const t = {
        ...
        fields: [
            ...
            { name: "État", task: 7, type: "select" },
            { name: "Type", task: 5, type: "select" },
            { name: "Priorité", placeholder: "Vital", task: 6, type: "select" },
            {
                multi: !1,
                name: "Attribué à",
                placeholder: "Cuisine",
...
function loadTicket(e) {
    e > 0 && socket.send({ f: 13, i: e });
}
document.addEventListener("mousemove", (e) => {
    e.target &&
        document.activeElement !== e.target &&
        "button" === e.target.nodeName.toLowerCase() &&
        "button" === document.activeElement.nodeName.toLocaleLowerCase() &&
        e.target.focus();
});
const pages = [
    {
...
function pageSelector(e) {
    ...
    for (const s of e)
        for (let e = 0; e < pages.length; e++)
            if (!t.includes(e))
                for (let n = 0; n < pages[e].role.length; n++)
                    parseInt(s) === parseInt(pages[e].role[n]) && t.push(e);
    return t;
}
function removePages() {
    tabuDestroy(main), (main.innerHTML = "");
}
function quicksort(e, t = 0) {
    if (e.length > 1) {
        const s = performance.now(),
            n = typeof e[0],
            i = "object" === n ? arr_ssb : num_ssb,
            a = "object" === n ? arr_iqp : num_iqp,
            o = "object" === n ? arr_is : num_is;
        let r = [],
            l = [0, e.length, 2 * Math.floor(Math.log(e.length) / Math.log(2))];
        for (r.push(l); r.length > 0; ) {
            l = r.pop();
            const s = l[0],
                n = l[1],
                o = Math.round((s + n) / 2);
            ...
            c--;
            const d = a(e, s, n, o, t);
            n - d > 16 && ((l = [d, n, c]), r.push(l)),
                d - s > 16 && ((l = [s, d, c]), r.push(l));
        }
        (e = o(e, t)), console.log(performance.now() - s + "ms quicksort");
    }
    return e;
}
function arrCompare(e, t, s) {
    for (let n = 0; n < s.length; n++) {
        let i = "object" == typeof e[s[n][1]] ? e[s[n][1]][0] : e[s[n][1]],
            a = "object" == typeof t[s[n][1]] ? t[s[n][1]][0] : t[s[n][1]];
        if (
            ((i = "string" == typeof i ? i.toLowerCase() : i),
            (a = "string" == typeof a ? a.toLowerCase() : a),
            i !== a)
        )
            return 0 === s[n][0] ? i > a : a > i;
    }
}
function objCompare(e, t, s) {
    for (let n = 0; n < s.length; n++) {
        const i = s[n][1],
            a = s[n][0];
        if (e[i] !== t[i])
            return (0 === a && e[i] > t[i]) || (1 === a && e[i] < t[i]);
    }
}
function num_ssb(e, t, s, n) {
    let i,
        a,
        o,
        r = Math.round((t + s) / 2);
    for (; r >= t; ) {
        for (i = r; i < s; i++) {
            if (((o = e[i]), (a = i), 0 === n))
                for (; a >= r && e[a - r] > o; ) (e[a] = e[a - r]), (a -= r);
            else for (; a >= r && e[a - r] < o; ) (e[a] = e[a - r]), (a -= r);
            e[a] = o;
        }
        r = Math.round(r / 2.2);
    }
...
function arr_ssb(e, t, s, n) {
    ...
    for (; r >= t; ) {
        for (i = r; i < s; i++) {
            for (o = e[i], a = i; a >= r && arrCompare(e[a - r], o, n); )
                (e[a] = e[a - r]), (a -= r);
            e[a] = o;
        }
        r = Math.round(r / 2.2);
...
function obj_shell_sort_bound(e, t, s, n) {
    let i,
        a,
        o,
        r = Math.round((t + s) / 2);
    for (; r >= t; ) {
        for (i = r; i < s; i++) {
            for (o = e[i], a = i; a >= r && objCompare(e[a - r], o, n); )
                (e[a] = e[a - r]), (a -= r);
            e[a] = o;
        }
        r = Math.round(r / 2.2);
...
function arr_iqp(e, t, s, n, i) {
    let a = t,
        o = s;
    const r = e[n];
    for (;;) {
        for (; arrCompare(r, e[a], i); ) a++;
        for (o--; arrCompare(e[o], r, i); ) o--;
        if (!(a < o)) return a;
        swap(e, a, o), a++;
    }
}
function obj_inplace_quicksort_partition(e, t, s, n, i) {
    let a = t,
        o = s;
    const r = e[n];
    for (;;) {
        for (; objCompare(r, e[a], i); ) a++;
        for (o--; objCompare(e[o], r, i); ) o--;
        if (!(a < o)) return a;
        swap(e, a, o), a++;
    }
}
function num_is(e, t, s) {
    for (let s = 1, n = e.length; s < n; s++) {
        const n = e[s];
        let i;
        for (
            i = s - 1;
            i >= 0 && !(0 === t && e[i] <= n) && !(1 === t && e[i] >= n);
            i--
        )
            e[i + 1] = e[i];
        e[i + 1] = n;
...
function arr_is(e, t) {
    for (let s = 1, n = e.length; s < n; s++) {
        const n = e[s];
        let i;
        for (i = s - 1; i >= 0 && e[i] !== n && !arrCompare(n, e[i], t); i--)
            e[i + 1] = e[i];
        e[i + 1] = n;
    }
    return e;
}
function obj_insertion_sort(e, t) {
    for (let s = 1, n = e.length; s < n; s++) {
        const n = e[s];
        let i;
        for (i = s - 1; i >= 0 && e[i] !== n && !objCompare(n, e[i], t); i--)
            e[i + 1] = e[i];
        e[i + 1] = n;
    }
    return e;
...
function dataGen(e, t) {
    ...
    for (var i = 0; i < e; i++)
        0 === t
            ? (s[i] = Math.round(1e6 * Math.random()))
            : 1 === t
            ? (s[i] = {
...
function builtInSortNum(e) {
    const t = performance.now();
    e.sort((e, t) => e - t), console.log(performance.now() - t);
}
function builtInSortArr(e, t, s, n, i) {
...
async function tabSwitch(e, t) {
    const s = document.querySelectorAll(".tab"),
        n = document.querySelectorAll(".nav-tab"),
        i = document.getElementsByClassName("title")[0],
        a = document.getElementsByClassName("toolbar");
    let o = t,
        r = e.querySelector("span").textContent;
    if (s[o].classList.contains("fadeout")) {
        refreshTabData(s[o]);
        for (var l = 0; l < s.length; l++)
            l === o
                ? (fadeIn(s[l]),
                  n[l].classList.add("selected"),
                  a[l].classList.remove("hide"))
                : (fadeOut(s[l]),
                  n[l].classList.remove("selected"),
                  a[l].classList.add("hide"));
        i.textContent = r;
    }
}
function setTabsListeners(e, t) {
...
function navTabs() {
    const e = document.querySelectorAll(".tab"),
        t = document.querySelectorAll(".nav-tab");
    t[0].classList.add("selected"),
        t.forEach(setTabsListeners),
        e.length !== t.length &&
            console.log(
                "Erreur : pas le même nombre de tabs que de selectors."
            );
}
function themifySetText() {
    const e = document.getElementById("theme-text");
    if (null != e) {
        const t = document.body,
            s = document.getElementById("darkIcon"),
            n = document.getElementById("lightIcon");
...
function themifyCache() {
    const e = localStorage.getItem("theme"),
        t = localStorage.getItem("isSolar"),
        s = document.body;
    e &&
        s.classList.contains("light") &&
        (t && s.classList.add("solar"),
        "light" !== e && (s.classList.replace("light", e), themifySetText()));
}
function themifyListeners() {
    const e = document.getElementById("themify"),
        t = document.getElementById("solar"),
        s = document.body;
    e.addEventListener("click", themify),
        t.addEventListener("click", function () {
            s.classList.toggle("solar"),
                s.classList.contains("solar")
                    ? localStorage.setItem("isSolar", !0)
...
class WSConnection {
                ...
                if ((console.log(data), 0 === this.#e))
                    if (data.name)
                        ...
                        data > 0
                            ? ((e =
                              ...
                              data < 7
                                  ...
                                  : 7 === data &&
                                    msg.new({
                                        content:
                                            "Trop d'essais consécutifs, merci de patienter quelques minutes avant de réessayer.",
                                    }))
                            : "-1" === data
                            ? msg.new({
                                  content:
                            ...
                            ? msg.new({
                                  content:
                                      "Veuillez patienter quelques minutes avant votre prochain essai,\n                            ou réinitialisez votre mot de passe.",
                                  btn0listener: () => login.blankBox(),
                              })
                            : "-4" === data &&
                              msg.new({
                    ...
                    if ("string" === data.response?.fail)
                        ...
                        const divs = document.querySelectorAll(
                            ...
                            tableEvents = data.response.event ?? void 0,
                            tables = Tabulator.findTable(
                                `fieldset[data-f='6'][data-t='${data.t}'] > .tabulator`
                            );
                        if ((delete data.response.event, tables))
                            for (let e of tables)
                                e.replaceData(data.response.data);
                        ...
                        if (data.i) {
                            const e = {
                                ...
                                fields: [
                                    ...
                                    },
                                    {
                                        add: (e) => {
                                            loadNewContact({
                                                childOf: e.closest("modal"),
                                                name: e.value,
                                                parentId: Array.from(
                                                    e.closest(".modal").children
                                                ).indexOf(e),
                                            });
                                        },
                                        grid: "3/5/4/6",
                                        ...
                                        task: 3,
                                        type: "selectize",
                                        value: data.response.client ?? void 0,
                                    },
                                    {
                                        grid: "3/6/4/7",
                                        multi: !1,
                                        ...
                                        task: 4,
                                        type: "selectize",
                                        value: data.response.assignee ?? void 0,
                                    },
                                    {
                                        grid: "4/5/5/7",
                                        name: "Type",
                            ...
                            new Modal(e),
                                BopChat.chats[0].wrapper.classList.add(
                                    "toggle"
                                );
                        }
                    } else if (14 === data.f)
                        ...
                        const e = BopChat.chats[0];
                        if (
                            data.response.last &&
                            !e.content.querySelector(
                                `[data-i="${data.i}"] fieldset[data-t='${data.response.last.created}'][data-i='${data.response.last.iduser}']`
                            )
                        )
                            return socket.send({ f: 14, i: data.i });
                        e.addMessage(data.response.new),
                            "user" ===
                                e.content
                                    .getElementsByTagName("datalist")[0]
                                    .querySelector(
                                ...
                                ((e.input.value = ""), (e.input.disabled = !1));
                    } else
                        17 === data.f
                            ? "request" === data.response.type
                                ? msg.new({
                                      type: "success",
                                ...
                                ? (msg.new({
                                  ...
                                  socket.send({ f: 14, i: data.response.chat }))
                            ...
                            : 2501 === data.f && BopTable.parseData(data);
            }),
            (this.ws.onclose = (e) => {
                (this.#e = 0),
                    console.log(
                    ...
                    BopChat.destroyAll(),
                    BopTable.destroyAll(),
                    ClassMain.el && (ClassMain.destroy(), login.load()),
                    1e3 !== e.code &&
                        msg.new({
                            content:
    ...
    addEventListener(e) {
        this.ws.addEventListener(e.type, e.action, (e.options = {}));
    }
}
