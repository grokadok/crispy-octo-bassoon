    ...
    ***************************************************************************** */
                ...
                if (eventRRuleData) {
                    return {
                        typeData: {
                            ...
                            isTimeZoneSpecified:
                                eventRRuleData.isTimeZoneSpecified,
                        },
    ...
    function parseEventRRule(eventProps, dateEnv) {
        ...
        for (
            ...
            isTimeZoneSpecified =
                isTimeZoneSpecified || res.timeZoneOffset !== null;
            rruleSet.exdate(
                new Date(
    ...
    function parseRRuleObject(rruleInput, dateEnv) {
        ...
        function processDateInput(dateInput) {
            if (typeof dateInput === "string") {
                ...
                if (markerData) {
                    isTimeSpecified =
                        isTimeSpecified || !markerData.isTimeUnspecified;
                    isTimeZoneSpecified =
                        isTimeZoneSpecified ||
                        markerData.timeZoneOffset !== null;
                    return new Date(
